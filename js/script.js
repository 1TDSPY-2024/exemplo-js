...
//Recuperando o elemento dialog - não funciona com getElementById
const modal = document.querySelector("dialog");


// Atrelando um evento ao botão
// 'eventoClique' de parâmetro da função é o eventoDeClique
btnLogin.addEventListener("click", function(eventoClique){

    // target substitui o this - target captura o elemento que acionou o evento
    // target captura quem acionou o eventoClique
    // console.log(eventoClique.target.innerText);
    modal.show();
})
...
btnClose.addEventListener("click", function(eventoClique){
